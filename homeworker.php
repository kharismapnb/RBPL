...
{
header("location:admin.php?pesan=not_logged_in");
}
?>
        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li class="scroll-to-section"><a href="infocareers.php">Job Vacancies</a></li>
        ...
        <div class="col-lg-6  align-self-center">
          ...
          <div class="row">
                  ...
                  <div class="main-button" style="margin-top: 15px; width: 100%">
                    <a href="careers.html">apply for a job</a>
                  </div>
                  </div>
                  <div class="col-md-6 mb-3">
                  <div class="main-button" style="margin-top: 15px;">
                    <a href="status.php">check job application status</a>
                  </div>
                  </div>
                </div>
        </div>
